...
keys = [
    ...
    Key([mod, "shift"], "f", lazy.window.toggle_fullscreen(), desc="Toggle focused window to fullscreen"),
    ...
    # Applications
    Key([mod], "l", lazy.spawn("./.scripts/looking-glass.sh"), desc="Start Virtual Machine"),
